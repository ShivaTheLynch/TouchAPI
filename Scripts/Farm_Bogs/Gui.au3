...
Global $mainGui =             GUICreate("BubbleTea's Bogroot Farmer", 388, 444, 191, 124)
...
Global Const $BogrootBox =           GUICtrlCreateCheckbox("Auto Loot?", 81, 92, 119, 25)
                                    GUICtrlSetFont(-1, 10, 400, 0, "Times New Roman")
                                    GUICtrlSetState(-1, $GUI_CHECKED)
...
Global Const $BogrootLabel =        GUICtrlCreateLabel("Bogroot Count: " & $BogrootCount, 24, 168, 100, 18)
                                    GUICtrlSetFont(-1, 8, 800, 0, "Times New Roman")
Global Const $GoldItemsLabel =      GUICtrlCreateLabel("Gold Items: " & $GoldItemsGained, 148, 168, 200, 18)
                                    GUICtrlSetFont(-1, 8, 800, 0, "Times New Roman")
...
Global Const $BogrootCountLabel =   GUICtrlCreateLabel("Bogroot: " & $BogrootCount, 148, 232, 100, 18)
                                    GUICtrlSetFont(-1, 8, 800, 0, "Times New Roman")
Global Const $GoldItemsLabel2 =     GUICtrlCreateLabel("Gold Items: " & $GoldItemsGained, 272, 232, 100, 18)
                                    GUICtrlSetFont(-1, 8, 800, 0, "Times New Roman")
    ...
    Switch @GUI_CtrlId
        ...
        Case $Button
			...
			Else
                ...
                GUICtrlSetState($BogrootBox, $GUI_DISABLE)  ; can't change Auto Loot or not
...
Func UpdateStatistics()
    ...
    GUICtrlSetData($BogrootCountLabel, "Bogroot: " & $BogrootCount)
    GUICtrlSetData($GoldItemsLabel, "Gold Items: " & $GoldItemsGained)
    GUICtrlSetData($GoldItemsLabel2, "Gold Items: " & $GoldItemsGained)
    GUICtrlSetData($BogrootLabel, "Bogroot Count: " & $BogrootCount)
EndFunc