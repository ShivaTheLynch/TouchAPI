...
Global $mainGui =             GUICreate("BubbleTea's Luxon Farmer", 388, 444, 191, 124)
...
Global Const $LuxonTitleLabel =     GUICtrlCreateLabel("Luxon Title: " & $LuxonTitle, 24, 168, 100, 18)
                                    GUICtrlSetFont(-1, 8, 800, 0, "Times New Roman")
Global Const $LuxonPointLabel =     GUICtrlCreateLabel("Luxon Points: " & $LuxonPointsGained, 148, 168, 200, 18)
                                    GUICtrlSetFont(-1, 8, 800, 0, "Times New Roman")
...
Func UpdateStatistics()
    ...
    GUICtrlSetData($LuxonTitleLabel, "Luxon Title: " & $LuxonTitle)
    GUICtrlSetData($LuxonPointLabel, "Luxon Points: " & $LuxonPointsGained)
EndFunc